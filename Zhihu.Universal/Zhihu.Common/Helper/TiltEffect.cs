...
namespace Zhihu.Common.Helper
{
    ...
    /// </summary>
    public sealed class TiltEffect : DependencyObject
    {
        /// <summary>
        ...
        private static Dictionary<DependencyObject, CacheMode> _originalCacheMode =
            new Dictionary<DependencyObject, CacheMode>();
        ...
        /// </summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Tiltable",
        ...
        [SuppressMessage("Microsoft.Performance", "CA1810:InitializeReferenceTypeStaticFieldsInline",
            Justification = "Need to initialize the tiltable items property.")]
        static TiltEffect()
        {
        ...
        [SuppressMessage("Microsoft.Design", "CA1062:Validate arguments of public methods", MessageId = "0",
            Justification = "Standard pattern.")]
        ...
        private static void TiltEffect_ManipulationStarted(object sender, ManipulationStartedRoutedEventArgs e)
        {
        ...
        /// <param name="e">Event arguments.</param>
        private static void TiltEffect_ManipulationDelta(object sender, ManipulationDeltaRoutedEventArgs e)
        {
        ...
        /// object (eg a button).</param>
        /// <param name="e">Event arguments.</param>
        private static void TiltEffect_ManipulationCompleted(object sender, ManipulationCompletedRoutedEventArgs e)
        {
        ...
        private static void TryStartTiltEffect(FrameworkElement source, ManipulationStartedRoutedEventArgs e)
        {
            foreach (FrameworkElement ancestor in (e.OriginalSource as FrameworkElement).GetVisualAncestors())
            {
                ...
                {
                    if (t.GetTypeInfo().IsAssignableFrom(ancestor.GetType().GetTypeInfo()))
                    {
                        ...
                        {
                            elementSuppressingTilt =
                                ancestor.GetVisualAncestors()
                                    .FirstOrDefault(x => x.ReadLocalValue(SuppressTiltProperty) is bool);
                        }

                        if (elementSuppressingTilt != null &&
                            (bool) elementSuppressingTilt.ReadLocalValue(SuppressTiltProperty) == true)
                        {
                            continue;
                        }
                        else
                        {
                            ...
                            FrameworkElement container = e.Container as FrameworkElement;

                            if (element == null || container == null)
                                return;

                            // Touch point relative to the element being tilted.
                            Point tiltTouchPoint = container.TransformToVisual(element).TransformPoint(e.Position);
    ...
    // Need to special-case the frame to handle different orientations.
            ...
            Point result = new Point(containerCenter.X - transformedElementCenter.X,
        ...
        private static void PrepareTiltReturnStoryboard(FrameworkElement element)
        {
            if (tiltReturnStoryboard == null)
            {
                ...
                Storyboard.SetTargetProperty(tiltReturnXAnimation, PlaneProjection.RotationXProperty.ToString());
                ...
                Storyboard.SetTargetProperty(tiltReturnYAnimation, PlaneProjection.RotationYProperty.ToString());
                ...
                Storyboard.SetTargetProperty(tiltReturnZAnimation, PlaneProjection.GlobalOffsetZProperty.ToString());
        ...
        private static void ContinueTiltEffect(FrameworkElement element, ManipulationDeltaRoutedEventArgs e)
        {
            FrameworkElement container = e.Container as FrameworkElement;
