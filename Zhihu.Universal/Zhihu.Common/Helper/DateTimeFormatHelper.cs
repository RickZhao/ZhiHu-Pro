...
namespace Zhihu.Common.Helper
{
    ...
    public static class DateTimeFormatHelper
    {
        ...
        /// </returns>
        public static Int32 GetRelativeDayOfWeek(DateTime dt)
        {
            return ((Int32)dt.DayOfWeek - (Int32)CultureInfo.CurrentCulture.DateTimeFormat.FirstDayOfWeek + 7) % 7;
        }
        ...
        {
            return ((Int32)(relative - given).TotalMinutes >= 7 * Day);
        }
        ...
        {
            return IsPastDayOfWeek(relative, given) && ((Int32)(relative - given).TotalMinutes > 3 * Hour);
        }
