...
namespace Zhihu.Common.HtmlAgilityPack
{
    ...
    public class HtmlAttributeCollection : IList<HtmlAttribute>
    {
        ...
        public Dictionary<String, HtmlAttribute> Hashitems = new Dictionary<String, HtmlAttribute>();
        ...
        /// </summary>
        public HtmlAttribute this[Int32 index]
        {
        ...
        public void CopyTo(HtmlAttribute[] array, Int32 arrayIndex)
        {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public Int32 IndexOf(HtmlAttribute item)
        {
        ...
        /// <param name="item"></param>
        public void Insert(Int32 index, HtmlAttribute item)
        {
            if (item == null)
            {
        ...
        public void Remove(HtmlAttribute attribute)
        {
            ...
            Int32 index = GetAttributeIndex(attribute);
            if (index == -1)
            {
        ...
        internal Int32 GetAttributeIndex(HtmlAttribute attribute)
        {
            if (attribute == null)
            {
                throw new ArgumentNullException("attribute");
        ...
        internal Int32 GetAttributeIndex(String name)
        {
            if (name == null)
            {
                throw new ArgumentNullException("name");
