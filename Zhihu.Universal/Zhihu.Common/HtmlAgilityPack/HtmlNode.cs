...
namespace Zhihu.Common.HtmlAgilityPack
{
    ...
    public partial class HtmlNode
    {
        ...
        internal Int32 _innerlength;
        internal Int32 _innerstartindex;
        internal Int32 _line;
        internal Int32 _lineposition;
        private String _name;
        internal Int32 _namelength;
        internal Int32 _namestartindex;
        internal HtmlNode _nextnode;
        internal HtmlNodeType _nodetype;
        internal String _outerhtml;
        internal Int32 _outerlength;
        internal Int32 _outerstartindex;
        ...
        internal Int32 _streamposition;
        ...
        public HtmlNode(HtmlNodeType type, HtmlDocument ownerdocument, Int32 index)
        {
            _nodetype = type;
        ...
        /// <param name="def">The default value to return if not found.</param>
        /// <returns>The value of the attribute if found, the default value if not found.</returns>
        public Int32 GetAttributeValue(String name, Int32 def)
        {
            if (name == null)
            {
                throw new ArgumentNullException("name");
            ...
            switch (_nodetype)
            {
                ...
                case HtmlNodeType.Document:
                    if (_ownerdocument.OptionOutputAsXml)
                    {
                        ...
                        {
                            Int32 rootnodes = _ownerdocument.DocumentNode._childnodes.Count;
                            if (rootnodes > 0)
                            {
