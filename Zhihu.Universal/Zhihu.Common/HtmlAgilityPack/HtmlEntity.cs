...
namespace Zhihu.Common.HtmlAgilityPack
{
    ...
    public class HtmlEntity
    {
        ...
        private static readonly Int32 _maxEntitySize;
        private static Dictionary<Int32, String> _entityName;
        private static Dictionary<String, Int32> _entityValue;

        /// <summary>
        /// A collection of entities indexed by name.
        /// </summary>
        public static Dictionary<Int32, String> EntityName
        {
        ...
        /// </summary>
        public static Dictionary<String, Int32> EntityValue
        {
        ...
        static HtmlEntity()
        {
            _entityName = new Dictionary<Int32, String>();
            _entityValue = new Dictionary<String, Int32>();
            ...
            _entityValue.Add("Int32", 8747); // integral, U+222B ISOtech 
            _entityName.Add(8747, "Int32");
                                ...
                                else
                                {
                                    if (entity[0] == '#')
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            Int32 code = Convert.ToInt32(codeStr, fromBase);
