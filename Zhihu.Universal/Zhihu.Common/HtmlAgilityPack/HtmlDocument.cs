...
namespace Zhihu.Common.HtmlAgilityPack
{
    ...
    public partial class HtmlDocument
    {
        ...
        /// </summary>
        public Int32 OptionExtractErrorSourceTextMaxLength = 100;
        ...
        public void Parse(String htmlContent)
        {
            ...
            if (OptionCheckSyntax)
                Openednodes = new Dictionary<Int32, HtmlNode>();
            else
                Openednodes = null;
            ...
            // html片段
            //_documentnode = CreateNode(HtmlNodeType.Element, 0);
...
#else
            OptionDefaultStreamEncoding = System.Text.Encoding.Default;
#endif
        ...
        {
            get { return _crc32 == null ? 0 : (Int32)_crc32.CheckSum; }
        }
        ...
        public static bool IsWhiteSpace(Int32 c)
        {
        ...
        public void Load(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks, Int32 buffersize)
        {
        ...
        internal HtmlNode CreateNode(HtmlNodeType type, Int32 index)
        {
            switch (type)
            {
        ...
        private void AddError(HtmlParseErrorCode code, Int32 line, Int32 linePosition, Int32 streamPosition, String sourceText, String reason)
        {
                ...
                switch (_state)
                {
                    ...
                    case ParseState.PcData:
                        ...
                        if ((_currentnode._namelength + 3) <= (Text.Length - (_index - 1)))
                        {
                            ...
                            {
                                Int32 c = Text[_index - 1 + 2 + _currentnode.Name.Length];
                                if ((c == '>') || (IsWhiteSpace(c)))
                                {
        ...
        private void PushAttributeValueEnd(Int32 index)
        {
            _currentattribute._valuelength = index - _currentattribute._valuestartindex;
        }

        private void PushAttributeValueStart(Int32 index)
        {
            PushAttributeValueStart(index, 0);
        }

        private void PushAttributeValueStart(Int32 index, Int32 quote)
        {
        ...
        private bool PushNodeEnd(Int32 index, bool close)
        {
        ...
        private void PushNodeNameEnd(Int32 index)
        {
        ...
        private void PushNodeNameStart(bool starttag, Int32 index)
        {
            _currentnode._starttag = starttag;
            _currentnode._namestartindex = index;
        }

        private void PushNodeStart(HtmlNodeType type, Int32 index)
        {
