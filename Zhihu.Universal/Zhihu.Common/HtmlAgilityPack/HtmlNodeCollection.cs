...
namespace Zhihu.Common.HtmlAgilityPack
{
    ...
    public class HtmlNodeCollection : IList<HtmlNode>
    {
        ...
        /// </summary>
        public Int32 this[HtmlNode node]
        {
            get
            {
        ...
        /// </summary>
        public HtmlNode this[Int32 index]
        {
        ...
        public void CopyTo(HtmlNode[] array, Int32 arrayIndex)
        {
        ...
        /// <param name="item"></param>
        /// <returns></returns>
        public Int32 IndexOf(HtmlNode item)
        {
        ...
        /// <param name="node"></param>
        public void Insert(Int32 index, HtmlNode node)
        {
            HtmlNode next = null;
            HtmlNode prev = null;
        ...
        /// <param name="node"></param>
        /// <returns></returns>
        public Int32 GetNodeIndex(HtmlNode node)
        {
        ...
        /// <param name="index"></param>
        /// <returns></returns>
        public bool Remove(Int32 index)
        {
            RemoveAt(index);
            return true;
        }
        ...
        /// <param name="index"></param>
        /// <param name="node"></param>
        public void Replace(Int32 index, HtmlNode node)
        {
            HtmlNode next = null;
            HtmlNode prev = null;
            HtmlNode oldnode = _items[index];
