...
{
    public sealed partial class ArticleCommentsPage : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                var vm = e.Parameter as ArticleViewModel;
        ...
        private void Comment_OnContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
        {
            ...
            else if (args.Phase == 4)
            {
                ...
                view.RegistEventHandler(CommentAuthorTapped);
            }
            args.Handled = true;
        }
        ...
        private void ShowContextMenu_OnTapped(object sender, TappedRoutedEventArgs e)
        {
        ...
        private async void CommentButton_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            var vm = this.DataContext as ArticleViewModel;

            vm?.CommentArticle.Execute(rslt.Content);
        }
