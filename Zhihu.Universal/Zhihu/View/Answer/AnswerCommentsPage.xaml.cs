...
{
    public sealed partial class AnswerCommentsPage : Page
    {
        public RelayCommand<Comment> CommentAuthorTapped { get; private set; }

        public AnswerCommentsPage()
        {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
                var vm = e.Parameter as AnswerViewModel;
        ...
        private async void CommentButton_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            vm?.CommentAnswer.Execute(rslt.Content);
        }
